	...
	<body>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">
								...
								专线拆机&nbsp;&nbsp;&nbsp;&nbsp;<code style="color: red;font-size: 10px;background: transparent;">( 带  * 的为必填项  )</code>
							</h3>
						</div>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="panel-3">
											<div class="row form-group">
												...
												<div class="col-sm-3">
					 							...
					 							<label for="plNo" class="col-sm-1 control-label">
					 								专线号&nbsp;<a style="color:red;text-align: right;">*</a>
				 								</label>
												<div class="col-sm-3">
													<div class="input-group">
											...
											<div class="row form-group">
												...
												<div class="col-sm-7">
													<input class="form-control" id="userName" type="text" placeholder="请输入名称"/>
												</div>
											</div>
											<div class="row form-group">
															...
															<div class="widget-box widget-color-blue">
																...
																<div class="widget-body">
																	<div class="widget-main padding-24">
																		...
																		<div class="row form-group">
																			<label class="col-sm-3 control-label">本次实收：</label>
																			<div class="col-sm-9">
																				<div class="input-group">
																					<div class="input-group-addon">
																						<span>￥</span>
						...
						<div class="panel-footer">
							<button type="button" id="save" class="btn btn-sm btn-primary" style="display: none;">拆机</button>
        ...
        $("#btnChooseUser").click(function() { 
        	...
        	fnUserChoosed = function(userId, businessKey) {
       			...
       			if ($("#customerType").val() == "1" && $("#creditorKey").val() == "") {
       				var res = ajaxCRUD("ocsBill!findBillInfo.do", {"obj.customerId": customerId}, false);
       				var obj = res.obj;
       				if (obj != null && obj != undefined) {
       					$("#accountAmount").val(obj.amount);
       					$("#accountAmountScore").val(obj.amountScore);
       					$("#billAmountDue").val(obj.amountDue);
       					calcAmountProceed()
       				}
       			}
        	};
