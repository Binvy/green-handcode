...
<html>
	...
	<body>
		...
		$(document).ready(function() {
			...
			loadRef("ref_business_type", "businessType", "--业务类型--");
		});
		...
		function initTableView() {
			table_view = $('#table_view').dataTable({
				...
				columnDefs: [ {
                    ...
                    render: function (a, b, c, d) {
                    	var fs = [];
                    	fs.push({"fn": "print('" + c.id + "','" + c.userType + "')", "color": "red", "icon": "print", "tooltip": "打印"});
                    	if (c.status == 0) {
		...
		$("#btnInquiry").click(function() {
			...
			if ($("#businessType").val() != "") {
				criteria["obj.businessType"] = $("#businessType").val();
			}
