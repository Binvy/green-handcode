										...
										<div class="panel panel-default">
											<div class="panel-body">
												...
												<div class="row form-group">
													...
													<label for="refund" class="col-xs-1">可退金额: </label>
													<div class="col-xs-3">
														<div class="input-group">
															<div class="input-group-addon">
																<span>￥</span>
															</div>
															<input type="text" id="refund" class="form-control" value="${billInfo.balance}" readonly/>	
														</div>
													</div>
												</div>
												<div class="row form-group">
													<label class="col-xs-1">退费金额:</label>
													<div class="col-xs-3">
														<div class="input-group">
															<div class="input-group-addon">
																<span>￥</span>
													...
													<label for="refundDesc" class="col-xs-1">退费说明: </label>
													<div class="col-xs-3">
														<input type="text" id="refundDesc" class="form-control"/>
													</div>	
												</div>
												<div class="row form-group">
											...
											<div class="panel-footer">
												<button type="button" id="save" class="btn btn-sm btn-primary">退费</button>
