...
<html>
	<head>
		...
		<script src="js/pricePlanDate.js"></script>
	</head>
	...
	<body>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">
								...
								修改宽带到期日&nbsp;&nbsp;&nbsp;&nbsp;<code style="color: red;font-size: 10px;background: transparent;">( 带  * 的为必填项  )</code>
							</h3>
						</div>
									...
									<div class="tab-content">
										...
										<div class="tab-pane" id="panel-1">
											<div class="row form-group">
												...
												<div class="col-sm-3">
													<select class="form-control" id="businessType" disabled="disabled"></select>
												</div>
													...
													<div class="widget-box widget-color-blue">
														...
														<div class="widget-body">
															<div class="widget-main no-padding">
																<table id="table_view_plan_date" class="table table-striped table-bordered table-hover">
																	<thead>
																		<tr>
																			<th>#</th>
													...
													<div class="row clearfix">
														...
														<div class="col-md-6 column">
															<div class="widget-box widget-color-blue">
																...
																<div class="widget-body">
																	<div class="widget-main no-padding">
																		<table id="table_view_product_date" class="table table-striped table-bordered table-hover">
																			<thead>
																				<tr>
																					<th>#</th>
																					<th><i class="icon-money orange bigger-110"></i></th>
															...
															<div class="widget-box widget-color-blue">
																...
																<div class="widget-body">
																	<div class="widget-main padding-24">
																		...
																		<div class="row form-group">
												 							<label for="changeDateRemark" class="col-sm-3 control-label">备注：</label>
																			<div class="col-sm-9">
																				<input class="form-control" id="changeDateRemark" type="text" placeholder="请输入备注"/>
																			</div>
																		</div>
																		<div class="row form-group">
        ...
        $("#btnChooseAccUser").click(function () { 
        	...
        	fnUserChoosed = function (userId, businessKey) {
       			...
       			initEditablePlanDate(userId);
       			$('#table_view_plan_date tbody').on('click', 'td.details-control', openPlanDateEditor);
       			$('#table_view_plan_date tbody').on('click', 'tr', onPlanDateRowSelected);
        	};
        	doSearch();
        	$("#dlgUser").modal("show");
        });
        ...
        $("#save").click(function () {
        	...
        	var remark = "业务类型:" + busiType + ",备注:" + ($("#changeDateRemark").val() ? $("#changeDateRemark").val() : "") + ";";
        	...
        	var index = 0;
        	var i = 0;
        	tableData = table_view_plan_date.rows().data();
        	...
        	for (i = 0; i < planCount; i++) {
        		...
        		if (true) {
    	    		...
    	    		parm["orderItems["+ index +"].dueTime"] = data.dueTime;
    	    		index++;
    	    	}
        	}
        	...
        	var res = ajaxCRUD("order!changeDate.do", parm, true);
        	if (res.resNum === "0") {
