					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">
								...
								专线过户&nbsp;&nbsp;&nbsp;&nbsp;<code style="color: red;font-size: 10px;background: transparent;">( 带  * 的为必填项  )</code>
							</h3>
						</div>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="panel-1">
											<div class="row form-group">
					 							<label for="businessKey1" class="col-sm-1 control-label">
					 								专线编号<a style="color:red;text-align: right;">*</a>
				 								</label>
												<div class="col-sm-3">
					 							...
					 							<label for="userName1" class="col-sm-1 control-label">
					 								用户名称
				 								</label>
												<div class="col-sm-7">
											...
											<div class="row form-group">
					 							<label for="newCustomerNo" class="col-sm-1 control-label">
					 								新客户号<a style="color:red;text-align: right;">*</a>
					 							</label>
												<div class="col-sm-3">
													<div class="input-group">
											...
											<div class="row form-group">
												...
												<div class="col-sm-3">
					 							...
					 							<label for="newUserName" class="col-sm-1 control-label">
					 								新用户名<a style="color:red;text-align: right;">*</a>
				 								</label>
												<div class="col-sm-7">
										...
										<div class="tab-pane" id="panel-4">
											<div class="row form-group">
												...
												<div class="col-sm-3">
													<input class="form-control" id="businessKey" type="text" placeholder="请输入专线号" />
												</div>
						...
						<div class="panel-footer">
							<button type="button" id="save" class="btn btn-sm btn-primary" style="display: none;">过户</button>
