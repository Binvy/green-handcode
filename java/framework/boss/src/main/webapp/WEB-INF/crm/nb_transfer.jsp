					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">
								...
								新业务过户&nbsp;&nbsp;&nbsp;&nbsp;<code style="color: red;font-size: 10px;background: transparent;">( 带  * 的为必填项  )</code>
							</h3>
						</div>
									...
									<div class="tab-content">
											...
											<div class="row form-group">
												...
												<div class="col-sm-3">
					 							...
					 							<label for="newCustomerName" class="col-sm-1 control-label">
					 								客户名称<a style="color:red;text-align: right;">*</a>
					 							</label>
												<div class="col-sm-7">
										...
										<div class="tab-pane" id="panel-4">
											<div class="row form-group">
												...
												<div class="col-sm-3">
													<input class="form-control" id="businessKey" type="text" placeholder="请输入业务编号" />
												</div>
											</div>
											<div class="row form-group">
