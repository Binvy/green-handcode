	...
	<body>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">
								...
								ADSL装机&nbsp;&nbsp;&nbsp;&nbsp;<code style="color: red;font-size: 10px;background: transparent;">( 带  * 的为必填项  )</code>
							</h3>
						</div>
        ...
        $(document).ready(function () {
       	...
       	$("#phoneNo").change(function(){
       		...
       		if (user == undefined || user == null) {
       			var c = confirm("电话用户" + $("#phoneNo").val() + "不存在，是否电话ADSL一起办理？");
       			if (c == true) {
       				$("#userPwd").val($("#phoneNo").val());
       				$("#acc").val("ADSL" + $("#phoneNo").val());
       				$("#phoneCreate").val("1");
       				$("#userRemark").val("与电话一起受理");
       				return;
       			} else {
       				$("#userPwd").val("");
       				$("#acc").val("");
        ...
        $("#save").click(function() {
        	...
        	if ($("#phoneCreate").val() == "1") {
        		...
        		var resPhone = ajaxCRUD("order!insert.do", parmPhone, false);
        		if (resPhone.resNum == "0") {
        			//var resCustomer = ajaxCRUD("customer!findByCustomerNo.do", {"obj.customerNo": $("#customerNo").val()}, false);
        			$("#customerId").val(resPhone.obj.customer.id);
        		} else {
        			bbAlert(resPhone.res);
        			return;
        		}
        	}
