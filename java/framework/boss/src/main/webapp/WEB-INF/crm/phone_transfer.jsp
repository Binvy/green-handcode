...
<html>
	...
	<body>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">
								...
								过户&nbsp;&nbsp;&nbsp;&nbsp;<code style="color: red;font-size: 10px;background: transparent;">( 带  * 的为必填项  )</code>
							</h3>
						</div>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="panel-1">
											<div class="row form-group">
												...
												<label for="businessKey" class="col-sm-1 control-label red">业务类型</label>
												<div class="col-sm-3">
											...
											<div class="row form-group">
												...
												<label for="pauseTime" class="col-sm-1 control-label">宽带到期日期</label>
												<div class="col-sm-3">
													<input class="form-control" id="pauseTime" readonly/>
												</div>
											</div>
											<div class="row form-group">
												<div class="col-sm-2"></div>
					 							<label for="oldCustomerNo" class="col-sm-1 control-label">原客户号</label>
												<div class="col-sm-3">
													<input class="form-control" id="oldCustomerNo" type="text" readonly/>
												</div>
												<label for="oldCustomerType" class="col-sm-1 control-label">原客户类型</label>
												<div class="col-sm-3">
													<select class="form-control" id="oldCustomerType" disabled="disabled" readonly></select>
												</div>
											</div>
											<div class="row form-group">
												<div class="col-sm-2"></div>
											...
											<div class="row form-group">
												...
												<div class="col-sm-7">
													<select id="userBills" class="selectpicker show-tick form-control" 
												...
												<div class="row form-group">
													...
													<div class="col-sm-3">
														<div class="input-group">
															...
															<input type="hidden" id="kdpauseTime">
															<span class="input-group-addon">
        ...
        $(document).ready(function () {
        	// 账单转移多选框初始化
			$("#userBills").selectpicker('render');
			$("#userBills").selectpicker('refresh');
			// 初始化客户类型
        ...
        $("#businessType").change(function () {
       	...
       	function loadUserBills(userId) {
			var res = ajaxCRUD("ocsBill!findUnpaidUserBills.do", {"obj.userId": userId}, false);
			var lst = res.lst;
			var html = "";
		...
		$("#btnChooseNewCustomer").click(function () {
			...
			fnBtnClickedCustomer = function (customerId, customerNo, customerName) {
				if (!customerId) {
					...
					if (!customer) return;
					$("#newCustomerType").val(customer.customerType);
					$("#newLinkPhone").val(customer.linkPhone);
				}
			};
        ...
        function validateInfo() {
        	if ($('#businessKey').val().trim() === "") {
				addTips(1, 1, "请输入或选择电话号码");
				return false;
			}
			if ($("#newCustomerId").val().trim() === "" && $("#newCustomerNo").val().trim() === "") {
				addTips(1, 5, "请选择过户目标客户或生成新客户");
        		return false;
        	}
        	if ($("#oldCustomerNo").val().trim() === $("#newCustomerNo").val().trim()) {
        		addTips(1, 5, "目标客户与原客户相同，无效的操作");
        		return false;
        	}
        	if ($("#newLinkPhone").val().trim() === "") {
        		addTips(1, 6, "请输入新用户的联系电话");
        		return false;
        	}
        	if ($("#newUserName").val().trim() === "") {
        		addTips(1, 7, "请输入新用户名称");
        		return false;
        	}
        	if ($("#newCustomerName").val().trim() === "") {
        		addTips(1, 8, "请输入新客户名称");
        		return false;
        	}
        	return true;
        }
        ...
        function validate() {
        	...
        	if (businessType !== "" && $("#userNo").val().trim() === "") {
        		bbAlert("请输入或选择用户编号");
        ...
        $("#save").click(function () {
        	...
        	var opParams = "newCustomerId:" + $("#newCustomerId").val() 
        					...
        					+ ",billMonths:" + userBills;
        	var remark = "业务类型:" + busiType + ",备注:" + ($("#transferRemark").val() ? $("#transferRemark").val() : "") + ";";
        	var parm = {
        		"obj.id": $("#userId").val(),
        		"obj.creator": op,
        		"obj.opType": opType,
