					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">
								<i class="icon-adjust red"></i>
								新业务停复&nbsp;&nbsp;&nbsp;&nbsp;<code style="color: red;font-size: 10px;background: transparent;">( 带  * 的为必填项  )</code>
							</h3>
						</div>
										...
										<div class="tab-pane active" id="panel-1">
											<div class="row form-group">
					 							<label for="businessKey1" class="col-sm-1 control-label">
					 								业务号&nbsp;<a style="color:red;text-align: right;">*</a>
					 							</label>
												<div class="col-sm-3">
													<div class="input-group">
													<input id="userId" type="hidden"/>
													<input class="form-control" id="businessKey1" type="text" placeholder="（输入业务号）查询"/>
