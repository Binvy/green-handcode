	...
	<body>
					...
					<div class="modal-body">
						<form class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-xs-9">
									<input type="text" id="itemField" class="form-control"/>
								</div>
							</div>
							<div class="form-group">
								<label class="col-xs-2 control-label no-padding">
								...
								<div class="col-xs-9">
									<input type="text" id="countField" class="form-control"/>
								</div>
							</div>
							<div class="form-group">
        ...
        $("#save").click(function() {
        	...
        	var parm = {
    			...
    			"obj.itemField": $("#itemField").val(),
    			"obj.countField": $("#countField").val()
        	};
        	...
        	if (resData.resNum == "0") {
        		...
        		if (flag == "add") {
        			...
        			node.itemField = $("#itemField").val();
        			node.countField = $("#countField").val();
        ...
        function detail(obj) {
        	...
        	$("#itemField").val(obj.itemField);
        	$("#countField").val(obj.countField);
        }
