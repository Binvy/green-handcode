...
<body>
    ...
    <div class="page-content">
        ...
        <div class="col-sm-2">
            ...
            <div class="col-sm-12">
                <button type="button" class="btn btn-sm btn-primary  pull-left" id="saveMenu">保存</button>
                <button type="button" class="btn btn-sm btn-primary  pull-right" id="reset">重置</button>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="width: 350px;">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-sm btn-primary " id="save">提交</button>
