...
<html>
	...
	<body>
		...
		<div class="page-content">
						...
						<div class="col-sm-12">
                            <div class="col-sm-12" style="padding-top:5px;padding-bottom:5px;">
                                <div>
	                                <span>分检开关:</span>
									<label>
										<input id="cdrFlag" class="ace ace-switch ace-switch-7" type="checkbox" checked/>
										<span class="lbl"></span>
									</label>
			...
			<div id="cdrLogs" style="width: 100%; height: 100%;">
			</div>
		</div>
					...
					<div class="modal-body">
						<form class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-xs-4">
									<input type="text" id="sourceDirectory" class="form-control"/>
								</div>
								<label class="col-xs-2 control-label no-padding">
									<font color="green"><b>缓存目录：</b></font>
								</label>
								<div class="col-xs-4">
									<input type="text" id="cachedDirectory" class="form-control"/>
								</div>
							</div>
							<div class="form-group">
								<label class="col-xs-2 control-label no-padding">
								...
								<div class="col-xs-4">
									<input type="text" id="archiveDirectory" class="form-control"/>
								</div>
								<label class="col-xs-2 control-label no-padding">解码器：</label>
								<div class="col-xs-4">
									<select class="form-control" id="decoderName">
							...
							<div class="form-group">
								...
								<div class="col-xs-4">
									<select class="form-control" id="collectMode">
							...
							<div class="form-group">
								...
								<label class="col-xs-2 control-label no-padding">修正量：</label>
								<div class="col-xs-4">
									<input type="text" id="correction" class="form-control" value="0">
								</div>
							</div>
							<div class="form-group">
    	...
    	$("#cdrFlag").change(function() {
    		var cdrFlag = $("#cdrFlag").get(0).checked ? 0 : 1;
    		//cdrFlag = "";
    		parm = {"cdrFlag" : cdrFlag };
			var res = ajaxCRUD("cdrSource!toggle.do", parm, false);
			if (cdrFlag === 0) {
				bbAlert("分检开启");
			} else {
				bbAlert("分检关闭");
			}
			var cdrLogs = res.cdrLogs.split("&");
			var i = 0;
			var html = "<pre>";
			for (i = 0; i< cdrLogs.length; i++) {
				html += "<p>" + decodeURIComponent(cdrLogs[i]) + "</p>";
			}
			html += "</pre>"
			$("#cdrLogs").empty();
			$("#cdrLogs").append(html);
