...
<body>
    <!-- 模态框（Modal） -->
	<div class="modal fade" id="dlgJobOpInfo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						...
						<ul class="nav nav-tabs">
							<li id="firstPage" class="active">
								<a href="#panel-1" data-toggle="tab">
									<i class="green icon-truck bigger-110"></i>
						 			工单信息
						 		</a>
							</li>
							<li>
						 		<a href="#panel-2" data-toggle="tab">
						 			<i class="red icon-user-md bigger-110"></i>
						 			客户信息
						 		</a>
							</li>
							<li>
							...
							<li>
						 		<a href="#panel-4" data-toggle="tab">
						 			<i class="dark icon-phone bigger-110"></i>
						 			用户信息
						 		</a>
							</li>
							<li>
						...
						<div class="tab-content">
							...
							<div class="tab-pane active" id="panel-1">
								<table id="" class="table table-striped table-bordered table-hover">
									 <tbody>
										<tr>
											<td width="15%"><b>业务操作名称</b></td><td class="ainfo" name="businessOpName" width="35%"></td>
											<td width="15%"><b>业务类型</b></td><td class="ainfo" name="processDefinitionName" width="35%"></td>
										</tr>
										<tr>
											<td><b>工单号</b></td><td class="ainfo" name="id"></td>
											<td><b>业务号</b></td><td class="ainfo" name="businessKey"></td>
										</tr>
										<tr>
											<td><b>发起人</b></td><td class="ainfo" name="originator"></td>
											<td><b>发起时间</b></td><td class="ainfo" name="originateTime"></td>
										</tr>
										<tr>
											<td><b>状态</b></td><td class="ainfo" name="status"></td>
											<td><b>单位</b></td><td class="ainfo" name="departmentName"></td>
										</tr>										
										<tr>
											<td><b>客户名</b></td><td class="ainfo" name="customerName"></td>
											<td><b>号码</b></td><td class="ainfo" name="userKey"></td>
										</tr>
										<tr>
											<td><b>VIP等级</b></td><td class="ainfo" name="vip"></td>
											<td><b>代理人</b></td><td class="ainfo" name="assignee"></td>
										</tr>
										<tr>
											<td><b>派单时间</b></td><td class="ainfo" name="dispatchTime"></td>
											<td><b>完工日期</b></td><td class="ainfo" name="finishTime"></td>
										</tr>	
										<tr>
											<td><b>备注</b></td><td class="ainfo" name="remark" colspan="3"></td>
										</tr>									
									</tbody>  
								</table>
							</div>
							...
							<div class="tab-pane" id="panel-2">
								<table id="table_view_customer" class="table table-striped table-bordered table-hover">
									<tbody>
										<tr>
											<td width="15%"><b>客户号</b></td><td class="binfo" name="customerNo" width="35%"></td>
											<td width="15%"><b>客户类型</b></td><td class="binfo" name="customerTypeDesc" width="35%"></td>
										</tr>
										<tr>
											<td><b>名称</b></td><td class="binfo" name="name"></td>
											<td><b>部门</b></td><td class="binfo" name="departmentName"></td>
										</tr>
										<tr>
											<td><b>地址</b></td><td class="binfo" name="address"></td>
											<td><b>证件号码</b></td><td class="binfo" name="certId"></td>
										</tr>
										<tr>
											<td><b>联系人</b></td><td class="binfo" name="linker"></td>
											<td><b>联系电话</b></td><td class="binfo" name="linkPhone"></td>
										</tr>
										<tr>
											<td><b>电子邮件</b></td><td class="binfo" name="email"></td>
											<td><b>联系地址</b></td><td class="binfo" name="linkAddress"></td>
										</tr>
										<tr>
											<td><b>VIP等级</b></td><td class="binfo" name="vipDesc"></td>
											<td><b>忠诚度</b></td><td class="binfo" name="loyaltyDesc"></td>
										</tr>
										<tr>
											<td><b>客户经理</b></td><td class="binfo" name="customerManager"></td>
											<td><b>备注</b></td><td class="binfo" name="remark"></td>
										</tr>
									</tbody>
								</table>
							</div>
							...
							<div class="tab-pane" id="panel-3">
								<table id="table_view_account" class="table table-striped table-bordered table-hover">
									<tbody>
										<tr>
											<td width="15%">客户号</td><td width="35%" class="cinfo" name="accNo"></td>
											<td width="15%">支付方式</td><td width="35%" class="cinfo" name="payMethodDesc"></td>
										</tr>
										<tr>
											<td>代缴客户</td><td class="cinfo" name="creditorName"></td>
											<td>银行名称</td><td class="cinfo" name="bankName"></td>
										</tr>
										<tr>
											<td>户主姓名</td><td class="cinfo" name="bankAccOwner"></td>
											<td>银行账户</td><td class="cinfo" name="bankAcc"></td>
										</tr>
										<tr>
											<td>账户余额</td><td class="cinfo" name="amount"></td>
											<td>备注</td><td class="cinfo" name="remark"></td>
										</tr>
									</tbody>
								</table>
							</div>
	...
	<script type="text/javascript">
	   // 加载工单信息数据
	   function loadJobOpInfo(id) {
		    loadInfo("jobOpInstance!findById.do", { "id": id }, "td.ainfo");
	   }
	   // 加载流程工单
	   function loadFormInfo(id) {
		    loadInfo("jobOpForm!findById.do", { "id": id }, "td.gdinfo");
	   }
	   // 加载客户信息
	   function loadCustomerInfo(customerNo) {
			loadInfo("customer!findByCustomerNo.do", { "obj.customerNo": customerNo }, "td.binfo");
	   }
	   // 加载账户信息
	   function loadAccountInfo(accNo) {
			loadInfo("account!findByAccNo.do", { "obj.accNo": accNo }, "td.cinfo");
	   }
	   // 加载订单信息
